...
?>
    ...
    <!--view-->
        <div class="container">
            <?php
            $res = "SELECT * FROM registration  WHERE status='off' ORDER BY  id DESC";
            ...
            if (isset($_GET['id'])) {
                $status = $_GET['id'];
                $query = "DELETE FROM registration WHERE id=$status";
                    ...
                    <?php while ($row = mysqli_fetch_array($result1)) { ?>
                        <tr>
                            <td>
                                ...
                                <a href="delete.php?id=<?php echo $row['id']; ?>"><b><i class="fas fa-trash-alt"></i></b></a>&nbsp;
